        ...
        <div class="w-full max-w-[1440px]  gap-10">
            <div class="flex flex-col md:flex-row w-full">
                ...
                <div class="flex basis-1/4 md:justify-end gap-5 md:py-0 py-4 text-white">
                    ...
                    <svg class="social-link-icon" width="30px" fill="#fff" height="30px" viewBox="0 0 24 24">
                        <path
            ...
            <div class="flex flex-col md:flex-row md:justify-end gap-5 text-xs py-2 text-gray-500">
                <p>Guides</p>
                <p>Terms of Sale</p>
                <p>Terms of Use</p>
                <p>Nike Privacy Policy</p>
            </div>
            <div class="flex flex-col md:flex-row md:justify-between text-xs py-2">
                <div class="flex flex-col md:flex-row gap-5">
                    <p class="flex gap-2 font-medium text-white items-center">
                        <img src="./src/icon/location.svg" alt=""> United state
                    </p>
                    <p class="text-gray-500">© 2024 Nike, Inc. All Rights Reserved</p>
                </div>
                <div class="flex flex-col md:flex-row gap-5 text-gray-500">
